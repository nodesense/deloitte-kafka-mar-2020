...
// kafka-topics --zookeeper k1.training.sh:2181 --create --topic statewise-invoices-count --replication-factor 1 --partitions 1

// kafka-console-consumer --bootstrap-server k1.training.sh:9092 --topic statewise-invoices-count --from-beginning --property print.key=true --property print.value=true --formatter kafka.tools.DefaultMessageFormatter --property value.deserializer=org.apache.kafka.common.serialization.LongDeserializer


// kafka-topics --zookeeper k1.training.sh:2181 --create --topic statewise-invoices-amount --replication-factor 1 --partitions 1
// kafka-console-consumer --bootstrap-server k1.training.sh:9092 --topic statewise-invoices-amount --from-beginning --property print.key=true --property print.value=true --formatter kafka.tools.DefaultMessageFormatter --property value.deserializer=org.apache.kafka.common.serialization.LongDeserializer
...
public class InvoiceStream {
    static  String bootstrapServers = "k1.training.sh:9092";
    //FIXME: chance schema url
    static String schemaUrl = "http://k1.training.sh:8081";
